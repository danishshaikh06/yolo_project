...
class SimpleHeadPoseDetector:
    def __init__(self):
        """Initialize the simplified head pose detector"""
        print("🚀 Initializing Simple Head Pose Detector...")
...
def main():
    """Main function"""
    print("🚀 Starting Simple Head Pose Detection System")
    ...
    try:
        while True:
            ...
            # Display
            cv2.imshow('Simple Head Pose Detection', frame)
